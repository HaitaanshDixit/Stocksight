...
stock_assets = {
    "RELIANCE.NS": {
        ...
        "scaler_file": "saved_models/reliance_scaler.save",
        "metrics_file": "model_metrics/Reliance_model_metrics.json"
    },
    "HDFCBANK.NS": {
        "model_file": "saved_models/HDFC_model.keras",
        "scaler_file": "saved_models/hdfc_scaler.save",
        "metrics_file": "model_metrics/HDFC_model_metrics.json"
    },
    "TATAMOTORS.NS": {
...
if stock is None:
    ...
    if st.button("Predict here"):
        # Load model and scaler
        try:
            model = load_keras_model(stock_assets[stock]["model_file"])
            scaler = load_scaler(stock_assets[stock]["scaler_file"])
